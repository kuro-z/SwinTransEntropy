...
class DatasetPaths(object):
    OPENIMAGES = '/data/zyj/openimages'
    CITYSCAPES = ''
    JETS = ''

class directories(object):
    experiments = 'experiments_ssim'
...
class args(object):
    ...
    k_M = 16.64           # Distortion
    k_P = 0                        # Perceptual loss
    ...
    # Scheduling
    lambda_schedule = dict(vals=[2., 1.], steps=[140000])
    lr_schedule = dict(vals=[1., 0.1], steps=[1400000])
    target_schedule = dict(vals=[0.20/0.14, 1.], steps=[140000])  # Rate allowance
